...
## Deployment validation and safety boundary
...
Standalone Gear WBC completed current-q HOLD, a 3-second smooth lower-body engage,
and a 5-second STAND validation under full physical support. The validated path uses
the guarded 500 Hz LowCmd transport as the sole writer while keeping upper-body
targets fixed during standalone lower-body commissioning.
