...
if __name__ == "__main__":
    ...
    # The processor validates every supplied embodiment horizon. Fine-tuning a
    # single embodiment must not be blocked by unrelated registry entries with
    # longer horizons than this model supports.
    config.data.modality_configs = {
        embodiment_tag: config.data.modality_configs[embodiment_tag]
    }
    ...
    config.model.model_name = (
        ft_config.backbone_model_path or "nvidia/Cosmos-Reason2-2B"
    )
